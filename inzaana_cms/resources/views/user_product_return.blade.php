...
<!--BEGIN TITLE & BREADCRUMB PAGE-->
        <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Product Returns</li>
          </ol>
          <div class="clearfix">
          </div>
        </div>
           ...
           <div class="row">
             ...
             <div class="col-lg-12">
                    <div class="panel panel-blue" style="background:#FFF;">
                            <div class="panel-heading">Product Returns</div>
                            <div class="panel-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>dd/mm/yyyy</td>
                                        <td>23</td>
                                        <td><span class="label label-sm label-warning">Returned</span></td>
                                    </tr>
                                    <tr>
                                        <td><a href="#">#7474</a></td>
                                        <td><a href="#">Baby Gentle Soap, Baby Powder, Baby Shampo, Baby Tow...</a></td>
