          ...
          <ul class="nav navbar navbar-top-links navbar-right mbn">
            ...
            <li class="dropdown topbar-user">
              <a data-hover="dropdown" href="#" class="dropdown-toggle">
                <img src="{{ asset('/dist/img/user2-160x160.jpg') }}" alt="" class="img-responsive img-circle" />&nbsp;<span class="hidden-xs">Hi, {{ isset($user) ? $user->name : "" }}</span>&nbsp;<span class="caret"></span>
              </a>
              <ul class="dropdown-menu dropdown-user pull-right">
                <li><a href="{{ isset($user) ? route('user::edit', [$user]) : '' }}"><i class="fa fa-user"></i>My Profile</a></li>
