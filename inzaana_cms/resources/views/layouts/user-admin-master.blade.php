      ...
      <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="topbar-main">
          ...
          <ul class="nav navbar navbar-top-links navbar-right mbn">
            ...
            <li >
              <a  href="#">
              <span class=""><i class="fa fa-shopping-cart"></i> My Cart</span>
              </a>
            </li>

            <li class="dropdown">
             <a  href="#">
              <span class="hidden-xs"><i class="fa fa-shopping-cart"></i> My Cart</span>
              </a>
            </li>
            ...
            <li class="dropdown topbar-user">
              <a data-hover="dropdown" href="#" class="dropdown-toggle">
                <img src="{{ asset('/dist/img/user2-160x160.jpg') }}" alt="" class="img-responsive img-circle" />&nbsp;<span class="hidden-xs">{{ isset($user) ? 'Hi, ' . $user->name : 'Go away! Unauthorized' }}</span>&nbsp;<span class="caret"></span>
              </a>
      ...
      <nav id="sidebar" role="navigation" data-step="2" data-position="right" class="navbar-default navbar-static-side nav-side-menu">
        ...
        <div class="sidebar-collapse menu-scroll menu-list">
          ...
          <ul id="side-menu" class="nav out">
            ...
            <li>
              <a href="/user_product_return">
                <i class="fa fa-tags fa-fw"></i>
                <span class="menu-title">Product Returns</span>
              </a>
            </li>
