             ...
             <div class="col-lg-12">
                    <div class="panel panel-blue" style="background:#FFF;">
                        <div class="panel-heading">
                            ...
                            <form action="#">
                                    <div class="row">
                                        <div class="col-md-7">Reward Points</div>
                                        <div class="col-md-3 text-right">
                                            <input type="text" placeholder="" class="form-control" />
                                        </div>
                                        <div class="col-md-2 text-left">
                                            <button class="btn btn-info">Credit to Wallet</button>
                                        </div>
                                    </div>
                            </form>
                            <!--Start form-->
                        ...
                        <div class="col-lg-12 padB10 padT10">
                            <p>Below is a summary of your Reward Points to date. For any information regarding Reward Points please <a href="#">click here.</a> <br>
                            <h2 class="label balance label-success">CURRENT BALANCE: $00</h2>
                        </div>
